...
.flex-x, .header__bar, .login__container, .tabcontent__form .buttons, .tabcontent .form-item, .footer__nav, .banner__toplist__info, .banner__toplist__info-description, .banner__toplist__info-description--desc .info-group, .banner__toplist__info-list .buttons, .filter-artist__select, .filter-artist__select ul, .filter-artist__genere, .filter-artist__covers {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.flex-y, .login, .tabcontent__form, .tabcontent .form-group, .banner__toplist__info-description--desc, .filter-artist {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.banner__toplist__info-list .buttons {
  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0)), color-stop(50%, #1d293f));
...
.banner__feature-background {
  background: -webkit-gradient(linear, left top, right top, from(rgba(15, 30, 54, 0)), color-stop(98.34%, #0F1E36));
...
.filter-artist__select ul li:active, .filter-artist__select ul li:hover {
  color: red;
}
...
.filter-artist__genere-item:active, .filter-artist__genere-item:hover {
